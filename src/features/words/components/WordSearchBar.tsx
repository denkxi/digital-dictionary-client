...
export default function WordSearchBar({
  ...
  return (
    <div className="border border-gray-200 rounded-xl bg-white shadow-sm px-4 py-4 space-y-4 mb-6 md:max-w-5xl md:mx-auto">
      ...
      <div className="flex flex-wrap gap-6 items-start text-sm mt-2">
        {/* Word Class filter */}
